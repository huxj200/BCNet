    ...
    for jdex, (img_dict, anno_dict_list) in enumerate(imgs_anns):
        ...
        if len(seg_list) > 0:
            for index, seg in enumerate(seg_list):
                ...
                seg['counts'] = bytes(seg['counts'], encoding='utf-8')
    ...
    for image_id, image_dict in enumerate(dataset_dicts):
        ...
        for annotation in anns_per_image:
            ...
            if "segmentation" in annotation:
                ...
                temp['counts'] = str(temp['counts'], encoding='utf-8')
                coco_annotation["segmentation"] = temp
...
if __name__ == "__main__":
    ...
    output_file = '/raid/users/hxj/datasets/logs/ann_train.json'
